...
class PolygonGogleMapScreen extends StatefulWidget{
  const PolygonGogleMapScreen({Key? key}) : super(key: key);

  @override
  State<PolygonGogleMapScreen> createState() => _PolygonGogleMapScreenState();
}

class _PolygonGogleMapScreenState extends State<PolygonGogleMapScreen> {
