...
class CustomInfoWindowMapScreen extends StatefulWidget {
  const CustomInfoWindowMapScreen({Key? key}) : super(key: key);

  @override
  State<CustomInfoWindowMapScreen> createState() =>
      _CustomInfoWindowMapScreenState();
}

class _CustomInfoWindowMapScreenState extends State<CustomInfoWindowMapScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Custom info windows "),
      ),
      body: Stack(
        children: <Widget>[
          GoogleMap(
